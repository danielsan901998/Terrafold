...
import { withinDistance, getDistance } from '../utils.js';
...
export default class ShipManager {
    ...
    static targetHome(ship) {
        return game.hangar.getTarget();
    }

    static returnHome(ship) {
    ...
    static moveToNearestTarget(ship) {
    ...
    static combineShips(ship1, ship2) {
