...
import { precision2, precision3 } from '../utils.js';
...
export default class Computer {
    ...
    this.processes = [
      {
        ...
        costType: "",
        finish: function () {
          game.land.improveLand();
          this.ticksNeeded = Math.floor(game.land.baseLand);
        },
        showing: function () {
          return true;
        },
      ...
      },
      {
        ...
        costType: "science",
        finish: function () {
          game.clouds.gainStormDuration(5);
          this.cost += 0.5;
          this.ticksNeeded += 50;
        },
        done: function () {
          return game.clouds.initialStormDuration >= 300;
        },
        showing: function () {
          return !this.done();
        },
      },
      {
        ...
        costType: "metal",
        finish: function () {
          game.robots.gainRobots(1);
        },
        showing: function () {
          return game.robots.unlocked;
        },
        done: function () {
          return game.robots.robots >= game.robots.robotMax;
        },
      },
      {
        //More Robot Storage
  ...
  removeThread(dataPos, numRemoving) {
